%=======================================================%
% Instruction：两张图像合成HDR原理为像素值加权和输出
% Date：2018/01/29
% Engineer：WangShiping
% Change：LiXiang
%=======================================================%

% imageL/imageM：输入RawData数据；
% bitWidth：为输入图像位宽
% expTimes + gainTimes：imageL/imageS的像素值比例关系；
% transAreaStart：过渡区域起始点，范围在(0,255）；
% transAreaLength：过渡区域长度,范围在<255-transAreaStart；
